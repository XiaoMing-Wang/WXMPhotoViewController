...
@interface WXMPhotoImageView ()
@property (nonatomic, strong) WXMPhotoGIFImage *animatedImage;
...
- (void)setAnimatedImage:(WXMPhotoGIFImage *)animatedImage {
